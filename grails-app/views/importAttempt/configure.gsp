    ...
    <body>
        ...
        <g:form name="configure" action="save" id="${importAttemptInstance.id}" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" id="inputSheet" placeholder="Sheet" name="sheetName" />
                </div>
            </div>
            <div class="form-group">
                <label for="inputStartRow" class="col-lg-2 control-label">Start Row</label>
                <div class="col-lg-10">
                    <input type="number" class="form-control" id="inputStartRow" placeholder="Row #" name="startRow" />
                </div>
            </div>
            <div class="form-group">
